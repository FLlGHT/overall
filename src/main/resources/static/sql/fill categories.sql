...
values (1, 'Самоопределение', 'Личные качества человека'),
       ...
       (4, 'Вещи', 'Отношение к вещам'),
       (5, 'Эмоции', 'Эмоциональность'),
       (6, 'Интеллект', 'Способность к познанию и решению проблем'),
       (7, 'Воля', ''),
       (8, 'Нравственность и мораль', '');
...
values (1, 'Трудолюбие', 'Отношение личности к процессу трудовой деятельности, стремление, много и усердно работать
       ...
       (5, 'Общительность', 'Cклонность к общению
                          0 (Замкнутный) - 99 (Общительный)', 2),
       ...
       (7, 'Самостоятельность', 'Cпособность действовать без чьего-либо вмешательства, самостоятельно принимать решения
       ...
       (13, 'Cкромность', 'Умеренность, cдержанность в демонстрации собственных достоинств или заслуг
